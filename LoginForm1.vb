...
Public Class LoginForm1
    ...
    Public strConnection As String = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\VendasDB.mdb"
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        ...
        Else
            ...
            If ds.Tables("Funcionarios").Rows.Count <> 0 Then
                ...
                strNivel = ds.Tables("Funcionarios").Rows(0).Item("Nivel")
                MsgBox(strNivel)
        ...
        If strNivel >= 2 Then
            FrmPrincipal.FATURASToolStripMenuItem.Enabled = True
            FrmPrincipal.PRODUTOSToolStripMenuItem1.Enabled = True
        Else
            FrmPrincipal.FATURASToolStripMenuItem.Enabled = True
            FrmPrincipal.PRODUTOSToolStripMenuItem1.Enabled = False
